...
from src.data_preprocessor.context_agnostic import ContextAgnosticPreprocessor
...
def train(args):
    ...
    preprocessor = ContextAgnosticPreprocessor(seq_len, batch_size)
    ...
    ## Train : Gun Control + Restaurant Feedback, Test: Gay Marriage
    fixed_data_test = {}
    free_data_test = {}

    fixed_data_test = update_dict(fixed_data_test,gm_fixed)
    free_data_test = update_dict(free_data_test,gm_free)
