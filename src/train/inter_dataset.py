...
from src.data_preprocessor.inter_dataset import InterDatasetPreprocessor
...
def train(args):
    ...
    preprocessor = InterDatasetPreprocessor(seq_len, batch_size)
    ...
    fixed_data_test.update(fixed_data)
    free_data_test.update(free_data)
