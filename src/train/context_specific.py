...
from src.data_preprocessor.context_specific import ContextSpecificPreprocessor
...
def train(args):
    ...
    preprocessor = ContextSpecificPreprocessor(seq_len, batch_size)
    ...
    ## Train : Gay Marriage Dataset, Test: Gay Marriage Dataset
    fixed_data_test = {}
    free_data_test = {}
